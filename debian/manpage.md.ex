% bitwarden-cli(SECTION) | User Commands
%
% "October  7 2025"
...
bitwarden-cli - program to do something

# SYNOPSIS

**bitwarden-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**bitwarden-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **bitwarden-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**bitwarden-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    bitwarden-cli. See **foo.conf**(5) for further details.
...
**bitwarden-cli** provides some return codes, that can be used in scripts:
